      ...
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur">
        <div className="flex h-16 items-center justify-between px-6 max-w-6xl mx-auto">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/marketplace" className="text-sm text-muted-foreground hover:text-foreground">Exchange</Link>
          </nav>
        ...
        <div className="max-w-6xl mx-auto grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/marketplace" className="hover:text-foreground">Exchange</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/marketplace/create" className="hover:text-foreground">Sell on Exchange</Link></li>
            </ul>
          </div>
          <div>
